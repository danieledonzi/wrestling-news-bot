...
| 2026-09-05 | `ED-2` | Legacy Menzo held production authority while Gemini Editorial Director V2.1 was non-binding Shadow evidence | With the dedicated Active flag enabled, Gemini Editorial Director V3 is primary semantic authority for the normal-news Menzo stage; frozen legacy Menzo is whole-run technical fallback only. The deterministic suspicion gate remains before Gemini, downstream authorities remain separate, and Publisher story-signature vetoes are non-authoritative. | OWNER GO ACTIVE; ED-1 Shadow validation; ED-1.1 grounding correction; NXT/Jasper Troy missed-story evidence; observed cost accepted as sustainable | Close semantic authority after evidence showed confirmed major developments lost by legacy selection while obsolete speculation survived |
