...
def test_metadata_propagation_actual_andrea_bob_alfred_publisher(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(bob, "call_gemini", lambda *a, **k: (json.dumps({"title_it":"Titolo italiano valido completo", "excerpt_it":"Estratto completo", "translations":{"b1":"La notizia principale presenta contenuti editoriali completi e informazioni verificate. " * 8}, "notes":[]}), "gemini-test", ["gemini-test"]))
